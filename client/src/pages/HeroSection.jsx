    ...
    <div className="relative bg-teal-500 text-white dark:bg-gray-900 dark:text-gray-100 py-20 px-4 mt-16">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="md:w-1/2 flex justify-center">
          <img
            src="https://img.freepik.com/free-photo/child-wearing-headphones-attending-virtual-school_23-2148766750.jpg?t=st=1721807333~exp=1721810933~hmac=c85d15726a8264752512b4330df12d9c1696dbbc8c1f805e6bdfd4b879f0a8c0&w=996"
            alt="Hero"
